          ...
          return controller.isLoading.value
              ...
              : ListView(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                            // ()=>{launchUrl(Uri.parse('${Urls.serverUrl}/product/product_detail3d/${controller.product.id}/'))};
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    Align(
                      ...
                      child: CustomButton(
                        text: 'Web View',
                        onPressed: ()=>{launchUrl(Uri.parse('${Urls.serverUrl}/product/product_detail/${controller.product.id}/')),},
                        fontSize: 16.sp,
